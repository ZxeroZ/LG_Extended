...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i <= i2) {
            while (true) {
                int i3 = i2 - 1;
                if (Intrinsics.areEqual(filePathComponentsNormalize$FilesKt__UtilsKt2.getSegments().get(i2).getName(), "..")) {
                    return null;
                }
                sb.append("..");
                if (i2 != i) {
    ...
    */
    ...
    public static final File resolve(File file, File relative) {
        ...
        String str = string;
        return ((str.length() == 0) || StringsKt.endsWith$default((CharSequence) str, File.separatorChar, false, 2, (Object) null)) ? new File(Intrinsics.stringPlus(string, relative)) : new File(string + File.separatorChar + relative);
    }
