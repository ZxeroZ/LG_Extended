    ...
    */
    public final synchronized java.lang.String readLine(java.io.InputStream r11, java.nio.charset.Charset r12) {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r11, r0)     // Catch: java.lang.Throwable -> Lce
            java.lang.String r0 = "charset"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r12, r0)     // Catch: java.lang.Throwable -> Lce
            java.nio.charset.CharsetDecoder r0 = kotlin.io.LineReader.decoder     // Catch: java.lang.Throwable -> Lce
            r1 = 0
            if (r0 == 0) goto L22
            if (r0 != 0) goto L18
            java.lang.String r0 = "decoder"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r0)     // Catch: java.lang.Throwable -> Lce
            r0 = r1
        L18:
            java.nio.charset.Charset r0 = r0.charset()     // Catch: java.lang.Throwable -> Lce
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r12)     // Catch: java.lang.Throwable -> Lce
            if (r0 != 0) goto L25
        L22:
            r10.updateCharset(r12)     // Catch: java.lang.Throwable -> Lce
        L25:
            r12 = 0
            r0 = r12
            r2 = r0
        L28:
            int r3 = r11.read()     // Catch: java.lang.Throwable -> Lce
            r4 = 32
            r5 = 10
            r6 = -1
            r7 = 1
            if (r3 != r6) goto L4e
            java.lang.StringBuilder r11 = kotlin.io.LineReader.sb     // Catch: java.lang.Throwable -> Lce
            java.lang.CharSequence r11 = (java.lang.CharSequence) r11     // Catch: java.lang.Throwable -> Lce
        ...
        L41:
            ...
            return r1
        L49:
            int r11 = r10.decodeEndOfInput(r0, r2)     // Catch: java.lang.Throwable -> Lce
            goto L7c
        L4e:
            byte[] r6 = kotlin.io.LineReader.bytes     // Catch: java.lang.Throwable -> Lce
            int r8 = r0 + 1
            byte r9 = (byte) r3     // Catch: java.lang.Throwable -> Lce
            r6[r0] = r9     // Catch: java.lang.Throwable -> Lce
            if (r3 == r5) goto L60
            if (r8 == r4) goto L60
            boolean r0 = kotlin.io.LineReader.directEOL     // Catch: java.lang.Throwable -> Lce
            if (r0 != 0) goto L5e
            goto L60
        L5e:
            r0 = r8
            goto L28
        L60:
            java.nio.ByteBuffer r0 = kotlin.io.LineReader.byteBuf     // Catch: java.lang.Throwable -> Lce
            r0.limit(r8)     // Catch: java.lang.Throwable -> Lce
            java.nio.CharBuffer r3 = kotlin.io.LineReader.charBuf     // Catch: java.lang.Throwable -> Lce
            r3.position(r2)     // Catch: java.lang.Throwable -> Lce
            int r2 = r10.decode(r12)     // Catch: java.lang.Throwable -> Lce
            if (r2 <= 0) goto Lc8
            char[] r3 = kotlin.io.LineReader.chars     // Catch: java.lang.Throwable -> Lce
            int r6 = r2 + (-1)
            char r3 = r3[r6]     // Catch: java.lang.Throwable -> Lce
            if (r3 != r5) goto Lc8
            r0.position(r12)     // Catch: java.lang.Throwable -> Lce
            r11 = r2
        L7c:
            if (r11 <= 0) goto L94
            char[] r0 = kotlin.io.LineReader.chars     // Catch: java.lang.Throwable -> Lce
            int r1 = r11 + (-1)
            char r1 = r0[r1]     // Catch: java.lang.Throwable -> Lce
            if (r1 != r5) goto L94
            int r11 = r11 + (-1)
            if (r11 <= 0) goto L94
            int r1 = r11 + (-1)
            char r0 = r0[r1]     // Catch: java.lang.Throwable -> Lce
            r1 = 13
            if (r0 != r1) goto L94
            int r11 = r11 + (-1)
        L94:
            java.lang.StringBuilder r0 = kotlin.io.LineReader.sb     // Catch: java.lang.Throwable -> Lce
            r1 = r0
            java.lang.CharSequence r1 = (java.lang.CharSequence) r1     // Catch: java.lang.Throwable -> Lce
        ...
        La1:
            ...
            r1.<init>(r0, r12, r11)     // Catch: java.lang.Throwable -> Lce
            monitor-exit(r10)
            return r1
        Lac:
            char[] r1 = kotlin.io.LineReader.chars     // Catch: java.lang.Throwable -> Lce
            r0.append(r1, r12, r11)     // Catch: java.lang.Throwable -> Lce
            ...
            if (r1 <= r4) goto Lc3
            r10.trimStringBuilder()     // Catch: java.lang.Throwable -> Lce
        Lc3:
            r0.setLength(r12)     // Catch: java.lang.Throwable -> Lce
            monitor-exit(r10)
            return r11
        Lc8:
            int r0 = r10.compactBytes()     // Catch: java.lang.Throwable -> Lce
            goto L28
        Lce:
            r11 = move-exception
            monitor-exit(r10)
