...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: android.util.ArrayMap */
    /* JADX WARN: Multi-variable type inference failed */
