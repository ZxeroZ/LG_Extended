...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.-$$Lambda$StreamsKt$bdU4-xB_0bnfvMo-xyX7v8aTfMQ
            @Override // java.util.function.Supplier
            public final Object get() {
                return StreamsKt.m2391asStream$lambda4(sequence);
            }
        }, 16, false);
    ...
    public static final Spliterator m2391asStream$lambda4(Sequence this_asStream) {
