...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2315getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            setResult(Result.m1127boximpl(result));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> resultM2315getResultxLWZpok = m2315getResultxLWZpok();
                if (resultM2315getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(resultM2315getResultxLWZpok.getValue());
                }
            }
        }
    }
