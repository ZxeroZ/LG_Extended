...
public final class Delegates {
    ...
    public final <T> ReadWriteProperty<Object, T> observable(T initialValue, Function3<? super KProperty<?>, ? super T, ? super T, Unit> onChange) {
        ...
        return new ObservableProperty<T>(initialValue, onChange) { // from class: kotlin.properties.Delegates.observable.1
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: kotlin.jvm.functions.Function3<? super kotlin.reflect.KProperty<?>, ? super T, ? super T, kotlin.Unit> */
    ...
    public final <T> ReadWriteProperty<Object, T> vetoable(T initialValue, Function3<? super KProperty<?>, ? super T, ? super T, Boolean> onChange) {
        ...
        return new ObservableProperty<T>(initialValue, onChange) { // from class: kotlin.properties.Delegates.vetoable.1
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: kotlin.jvm.functions.Function3<? super kotlin.reflect.KProperty<?>, ? super T, ? super T, java.lang.Boolean> */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(initialValue);
