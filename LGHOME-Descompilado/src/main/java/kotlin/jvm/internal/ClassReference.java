...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    public static final class Companion {
        ...
        public final String getClassSimpleName(Class<?> jClass) {
            ...
            if (!jClass.isAnonymousClass()) {
                ...
                if (componentType.isPrimitive() && (str = (String) ClassReference.simpleNames.get(componentType.getName())) != null) {
                    strStringPlus = Intrinsics.stringPlus(str, "Array");
                }
        ...
        public final String getClassQualifiedName(Class<?> jClass) {
            ...
            return strStringPlus == null ? "kotlin.Array" : strStringPlus;
        }
    ...
    static {
        ...
        for (String kotlinName : collectionValues) {
            ...
            Pair pair = TuplesKt.to(sbAppend.append(StringsKt.substringAfterLast$default(kotlinName, '.', (String) null, 2, (Object) null)).append("CompanionObject").toString(), Intrinsics.stringPlus(kotlinName, ".Companion"));
            map3.put(pair.getFirst(), pair.getSecond());
        }
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : FUNCTION_CLASSES.entrySet()) {
            map3.put(entry.getKey().getName(), Intrinsics.stringPlus("kotlin.Function", Integer.valueOf(entry.getValue().intValue())));
        }
        classFqNames = map3;
