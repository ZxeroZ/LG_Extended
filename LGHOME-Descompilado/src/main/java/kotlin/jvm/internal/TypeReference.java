...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        return Intrinsics.areEqual(strAsString, str) ? str : Intrinsics.areEqual(strAsString, Intrinsics.stringPlus(str, "?")) ? Intrinsics.stringPlus(str, "!") : '(' + str + ".." + strAsString + ')';
    }
    ...
    public final String asString(KTypeProjection kTypeProjection) {
        ...
        String strValueOf = typeReference == null ? String.valueOf(kTypeProjection.getType()) : typeReference.asString(true);
        int i = WhenMappings.$EnumSwitchMapping$0[kTypeProjection.getVariance().ordinal()];
        if (i == 1) {
            return strValueOf;
        }
        if (i == 2) {
            return Intrinsics.stringPlus("in ", strValueOf);
        }
        if (i == 3) {
            return Intrinsics.stringPlus("out ", strValueOf);
        }
