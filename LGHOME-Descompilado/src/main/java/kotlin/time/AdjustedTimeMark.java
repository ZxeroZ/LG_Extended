...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo2405elapsedNowUwyO8pc() {
        return Duration.m2447minusLRDsOJo(this.mark.mo2405elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2406plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2448plusLRDsOJo(getAdjustment(), duration), null);
    }
}
