...
class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndentByMargin(String str, String newIndent, String marginPrefix) {
        ...
        for (Object obj : listLines) {
            ...
            String strInvoke = (String) obj;
            String strSubstring = null;
            if ((i2 == 0 || i2 == lastIndex) && StringsKt.isBlank(strInvoke)) {
                strInvoke = null;
            } else {
                int length2 = strInvoke.length();
                int i4 = 0;
                while (true) {
                    if (i4 >= length2) {
                        i = -1;
                ...
                if (i != -1) {
                    int i6 = i;
                    if (StringsKt.startsWith$default(strInvoke, marginPrefix, i, false, 4, (Object) null)) {
                        strSubstring = strInvoke.substring(i6 + marginPrefix.length());
                        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
                    }
                }
                if (strSubstring != null) {
                    strInvoke = indentFunction$StringsKt__IndentKt.invoke(strSubstring);
                }
            }
            if (strInvoke != null) {
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        for (Object obj2 : list) {
            ...
            String strInvoke = (String) obj2;
            if ((i == 0 || i == lastIndex) && StringsKt.isBlank(strInvoke)) {
                strInvoke = null;
            } else {
                String strDrop = StringsKt.drop(strInvoke, iIntValue);
                if (strDrop != null) {
                    strInvoke = indentFunction$StringsKt__IndentKt.invoke(strDrop);
                }
            }
            if (strInvoke != null) {
                arrayList4.add(strInvoke);
            }
            i = i2;
        }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        for (Object obj : list) {
            ...
            if ((i2 == 0 || i2 == lastIndex) && StringsKt.isBlank(strInvoke)) {
                ...
                String strInvoke2 = function12.invoke(strInvoke);
                if (strInvoke2 != null) {
