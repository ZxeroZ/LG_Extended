...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2318getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        int iM1300constructorimpl = ((((int) ULong.m1300constructorimpl(getFirst() ^ ULong.m1300constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m1300constructorimpl(getLast() ^ ULong.m1300constructorimpl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return iM1300constructorimpl + ((int) (j ^ (j >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m1345toStringimpl(getFirst())).append("..").append((Object) ULong.m1345toStringimpl(getLast())).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m1345toStringimpl(getFirst())).append(" downTo ").append((Object) ULong.m1345toStringimpl(getLast())).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2341fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
