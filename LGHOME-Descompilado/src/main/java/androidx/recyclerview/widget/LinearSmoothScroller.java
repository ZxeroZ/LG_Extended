...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        action.update((int) (this.mInterimTargetDx * 1.2f), (int) (this.mInterimTargetDy * 1.2f), (int) (calculateTimeForScrolling(TARGET_SEEK_SCROLL_DISTANCE_PX) * 1.2f), this.mLinearInterpolator);
    }
