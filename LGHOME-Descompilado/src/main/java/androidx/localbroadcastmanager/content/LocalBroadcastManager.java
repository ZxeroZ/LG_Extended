                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (iMatch >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (iMatch != -4 ? iMatch != -3 ? iMatch != -2 ? iMatch != -1 ? "unknown reason" : SBContract.SmartBulletin.NOTI_TYPE : "data" : ActionManagerConstants.KEY_ACTION_ID : ActionManager.EXTRA_BOARD_CATEGORY));
                        }
                    }
