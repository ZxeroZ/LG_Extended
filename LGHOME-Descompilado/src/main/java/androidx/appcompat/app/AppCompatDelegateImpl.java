...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.1
            ...
            private boolean shouldWrapException(Throwable th) {
                ...
                return message.contains(LauncherConst.RESOURCE_IMAGE_TYPE) || message.contains("Drawable");
            }
        });
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r12v0, resolved type: android.view.View */
    ...
    */
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z3 = false;
        if ((sAlwaysOverrideConfiguration || i3 != i2) && !zIsActivityManifestHandlingUiMode && Build.VERSION.SDK_INT >= 17 && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z3 && i4 != i3 && z && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached && (Build.VERSION.SDK_INT >= 17 || this.mCreated)) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
        ...
        if (z3 || i4 == i3) {
            ...
            updateResourcesConfigurationForNightMode(i3, zIsActivityManifestHandlingUiMode);
        }
        if (z2) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v6, resolved type: android.app.Activity */
    /* JADX WARN: Multi-variable type inference failed */
