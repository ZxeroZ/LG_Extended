...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 21 && (listCombineLists2 = combineLists(getPeople(b.mPersonList), b.mPeople)) != null && !listCombineLists2.isEmpty()) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (Build.VERSION.SDK_INT < 28) {
                listCombineLists = combineLists(getPeople(b.mPersonList), b.mPeople);
            } else {
                listCombineLists = b.mPeople;
            }
