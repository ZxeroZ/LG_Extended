...
public class TypefaceCompatApi28Impl extends TypefaceCompatApi26Impl {
    ...
    protected Method obtainCreateFromFamiliesWithDefaultMethod(Class<?> fontFamily) throws NoSuchMethodException {
        Method declaredMethod = Typeface.class.getDeclaredMethod(CREATE_FROM_FAMILIES_WITH_DEFAULT_METHOD, Array.newInstance(fontFamily, 1).getClass(), String.class, Integer.TYPE, Integer.TYPE);
