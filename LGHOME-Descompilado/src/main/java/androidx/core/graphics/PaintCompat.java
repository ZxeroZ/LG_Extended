...
public final class PaintCompat {
    ...
    public static boolean hasGlyph(Paint paint, String string) {
        ...
        float fMeasureText3 = paint.measureText(string);
        ...
        if (string.codePointCount(0, string.length()) > 1) {
            ...
            int i = 0;
            while (i < length) {
                int iCharCount = Character.charCount(string.codePointAt(i)) + i;
                fMeasureText4 += paint.measureText(string, i, iCharCount);
                i = iCharCount;
            }
        ...
        paint.getTextBounds(string, 0, length, pairObtainEmptyRects.second);
