...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean z) {
        ...
        if (viewOnFindViewById != null && viewOnFindViewById.getTag(R.id.visible_removing_fragment_view_tag) != null) {
            viewOnFindViewById.setTag(R.id.visible_removing_fragment_view_tag, null);
        }
        ...
        if (nextTransition != 0 && (iTransitToAnimResourceId = transitToAnimResourceId(nextTransition, z)) >= 0) {
            return new AnimationOrAnimator(AnimationUtils.loadAnimation(context, iTransitToAnimResourceId));
        }
        return null;
    }
