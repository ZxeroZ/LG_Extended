...
class FloatingActionButtonImpl {
    ...
    void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        MaterialShapeDrawable materialShapeDrawableCreateShapeDrawable2 = createShapeDrawable();
        materialShapeDrawableCreateShapeDrawable2.setTintList(RippleUtils.convertToRippleDrawableColor(colorStateList2));
        this.rippleDrawable = materialShapeDrawableCreateShapeDrawable2;
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) Preconditions.checkNotNull(this.shapeDrawable), materialShapeDrawableCreateShapeDrawable2});
    }
    ...
    final void setShapeAppearance(ShapeAppearanceModel shapeAppearanceModel, boolean z) {
        if (z) {
    ...
    void addTransformationListener(InternalTransformationListener internalTransformationListener) {
    ...
    void removeTransformationListener(InternalTransformationListener internalTransformationListener) {
    ...
    void updateSize() {
        ...
        if (!this.usingDefaultCorner || (materialShapeDrawable = this.shapeDrawable) == null) {
            return;
        }
        materialShapeDrawable.getShapeAppearanceModel().setCornerRadius(this.view.getSizeDimension() / 2.0f);
    }
    ...
    void getPadding(Rect rect) {
        ...
        int iMax = Math.max(sizeDimension, (int) Math.ceil(getElevation() + this.pressedTranslationZ));
    ...
    MaterialShapeDrawable createShapeDrawable() {
        ...
        if (this.usingDefaultCorner) {
            shapeAppearanceModel.setCornerRadius(this.view.getSizeDimension() / 2.0f);
        }
