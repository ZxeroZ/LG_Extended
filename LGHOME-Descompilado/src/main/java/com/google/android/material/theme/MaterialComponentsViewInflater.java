...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    protected boolean shouldInflateAppCompatButton(Context context, AttributeSet attributeSet) {
        ...
        if (floatingToolbarItemBackgroundResId == -1) {
            floatingToolbarItemBackgroundResId = context.getResources().getIdentifier("floatingToolbarItemBackgroundDrawable", "^attr-private", LauncherConst.PACKAGE_NAME_NATIVE);
        }
