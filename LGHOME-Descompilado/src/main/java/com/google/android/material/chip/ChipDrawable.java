...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int[][] states = {new int[]{R.attr.state_enabled, R.attr.state_selected}, new int[]{R.attr.state_enabled, R.attr.state_checked}, new int[]{R.attr.state_enabled}, new int[0]};
    ...
    private boolean onStateChange(int[] iArr, int[] iArr2) {
        ...
        int colorForState4 = colorStateList4 != null ? colorStateList4.getColorForState(iArr, this.currentCompatRippleColor) : 0;
        ...
        int colorForState6 = colorStateList5 != null ? colorStateList5.getColorForState(iArr, this.currentTint) : 0;
    ...
    private ColorStateList compositeSurfaceBackgroundColor(ColorStateList colorStateList, ColorStateList colorStateList2) {
        return MaterialColors.layer(colorStateList2, this.currentChipSurfaceColor, colorStateList, this.currentChipBackgroundColor, states);
    }
