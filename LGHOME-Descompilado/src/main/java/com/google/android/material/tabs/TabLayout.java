...
public class TabLayout extends HorizontalScrollView {
    ...
    protected OnTabSelectedListener wrapOnTabSelectedListener(final BaseOnTabSelectedListener baseOnTabSelectedListener) {
        ...
        OnTabSelectedListener onTabSelectedListener = new OnTabSelectedListener() { // from class: com.google.android.material.tabs.TabLayout.1
