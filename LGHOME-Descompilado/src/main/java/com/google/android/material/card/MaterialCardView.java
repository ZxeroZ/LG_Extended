...
public class MaterialCardView extends CardView implements Checkable {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialCardView, i, i2, new int[0]);
    ...
    void setContentLayoutPadding(int i, int i2, int i3, int i4) {
