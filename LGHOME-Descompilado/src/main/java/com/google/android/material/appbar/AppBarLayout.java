...
public class AppBarLayout extends LinearLayout {
    ...
    boolean shouldLift(View view) {
        View viewFindLiftOnScrollTargetView = findLiftOnScrollTargetView();
    ...
    private View findLiftOnScrollTargetView() {
        ...
        if (this.liftOnScrollTargetView == null && this.liftOnScrollTargetViewId != -1) {
            ...
            if (activity != null) {
                viewFindViewById = activity.findViewById(this.liftOnScrollTargetViewId);
            } else {
                viewFindViewById = getParent() instanceof ViewGroup ? ((ViewGroup) getParent()).findViewById(this.liftOnScrollTargetViewId) : null;
            }
