...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        ShapeAppearanceModel shapeAppearanceModel = new ShapeAppearanceModel(context2, attributeSet, i, i2, -1);
        boolean zIsUsingDefaultCorner = isUsingDefaultCorner(shapeAppearanceModel);
        ...
        getImpl().setShapeAppearance(shapeAppearanceModel, zIsUsingDefaultCorner);
    ...
    public void addTransformationListener(TransformationListener<? extends FloatingActionButton> transformationListener) {
        getImpl().addTransformationListener(new TransformationListenerWrapper(transformationListener));
    }

    public void removeTransformationListener(TransformationListener<? extends FloatingActionButton> transformationListener) {
    ...
    class TransformationListenerWrapper<T extends FloatingActionButton> implements FloatingActionButtonImpl.InternalTransformationListener {
        private final TransformationListener<T> listener;

        TransformationListenerWrapper(TransformationListener<T> transformationListener) {
