...
public final class InternalNano {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:30:0x000d */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:34:0x000d */
    /* JADX DEBUG: Multi-variable search result rejected for r3v1, resolved type: android.util.ArrayMap */
    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: V */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r7v5, resolved type: java.lang.Object */
    ...
    public static void cloneUnknownFieldData(ExtendableMessageNano extendableMessageNano, ExtendableMessageNano extendableMessageNano2) {
        if (extendableMessageNano.unknownFieldData != null) {
            extendableMessageNano2.unknownFieldData = extendableMessageNano.unknownFieldData.m602clone();
        }
    }
}
