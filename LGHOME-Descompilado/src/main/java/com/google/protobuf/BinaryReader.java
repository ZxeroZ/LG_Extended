...
abstract class BinaryReader implements Reader {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] (LINE:52) call: com.google.protobuf.BinaryReader.<init>():void type: THIS */
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private long readVarint64SlowPath() throws IOException {
            ...
            for (int i = 0; i < 64; i += 7) {
                byte b = readByte();
                j |= ((long) (b & ByteCompanionObject.MAX_VALUE)) << i;
