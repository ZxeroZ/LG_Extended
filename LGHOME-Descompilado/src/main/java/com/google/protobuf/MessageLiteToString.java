...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (((Method) map2.get("set" + strReplaceFirst)) != null && (!strReplaceFirst.endsWith(BYTES_SUFFIX) || !map.containsKey("get" + strReplaceFirst.substring(0, strReplaceFirst.length() - 5)))) {
    ...
    static final void printField(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof Map.Entry) {
            ...
            int i4 = i + 2;
            printField(sb, i4, LauncherSettings.HomePreferences.KEY, entry.getKey());
