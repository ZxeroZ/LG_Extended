...
public final /* data */ class DoubleFlag implements ParcelableFlag<Double> {
    ...
    public static final Parcelable.Creator<DoubleFlag> CREATOR = new Parcelable.Creator<DoubleFlag>() { // from class: com.android.systemui.flags.DoubleFlag$Companion$CREATOR$1
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public DoubleFlag[] newArray(int size) {
            return new DoubleFlag[size];
        }
    };

    public DoubleFlag(int i) {
        this(i, 0.0d, false, 6, null);
    }

    public DoubleFlag(int i, double d) {
        this(i, d, false, 4, null);
    }

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 android.os.Parcel) A[MD:(android.os.Parcel):void (m)] call: com.android.systemui.flags.DoubleFlag.<init>(android.os.Parcel):void type: THIS */
    ...
    public final DoubleFlag copy(int id, double d, boolean teamfood) {
        return new DoubleFlag(id, d, teamfood);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DoubleFlag)) {
            return false;
        }
        DoubleFlag doubleFlag = (DoubleFlag) other;
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x000b: CONSTRUCTOR 
      (r1v0 int)
      (wrap:double:?: TERNARY null = ((wrap:int:0x0000: ARITH (r5v0 int) & (2 int) A[WRAPPED]) != (0 int)) ? (0.0d double) : (r2v0 double))
      (wrap:boolean:?: TERNARY null = ((wrap:int:0x0006: ARITH (r5v0 int) & (4 int) A[WRAPPED]) != (0 int)) ? false : (r4v0 boolean))
     A[MD:(int, double, boolean):void (m)] (LINE:203) call: com.android.systemui.flags.DoubleFlag.<init>(int, double, boolean):void type: THIS */
    ...
    public Double getDefault() {
        return Double.valueOf(this.default);
    }
