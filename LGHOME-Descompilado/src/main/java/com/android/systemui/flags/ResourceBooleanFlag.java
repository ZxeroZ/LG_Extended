...
public final /* data */ class ResourceBooleanFlag implements ResourceFlag<Boolean> {
    ...
    public final ResourceBooleanFlag copy(int id, int resourceId, boolean teamfood) {
        return new ResourceBooleanFlag(id, resourceId, teamfood);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ResourceBooleanFlag)) {
            return false;
        }
        ResourceBooleanFlag resourceBooleanFlag = (ResourceBooleanFlag) other;
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0005: CONSTRUCTOR 
     ...
     A[MD:(int, int, boolean):void (m)] (LINE:71) call: com.android.systemui.flags.ResourceBooleanFlag.<init>(int, int, boolean):void type: THIS */
