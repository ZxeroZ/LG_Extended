...
public final /* data */ class ResourceIntFlag implements ResourceFlag<Integer> {
    ...
    public final ResourceIntFlag copy(int id, int resourceId, boolean teamfood) {
        return new ResourceIntFlag(id, resourceId, teamfood);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ResourceIntFlag)) {
            return false;
        }
        ResourceIntFlag resourceIntFlag = (ResourceIntFlag) other;
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0005: CONSTRUCTOR 
     ...
     A[MD:(int, int, boolean):void (m)] (LINE:141) call: com.android.systemui.flags.ResourceIntFlag.<init>(int, int, boolean):void type: THIS */
