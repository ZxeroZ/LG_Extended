...
public final /* data */ class ResourceStringFlag implements ResourceFlag<String> {
    ...
    public final ResourceStringFlag copy(int id, int resourceId, boolean teamfood) {
        return new ResourceStringFlag(id, resourceId, teamfood);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ResourceStringFlag)) {
            return false;
        }
        ResourceStringFlag resourceStringFlag = (ResourceStringFlag) other;
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0005: CONSTRUCTOR 
     ...
     A[MD:(int, int, boolean):void (m)] (LINE:110) call: com.android.systemui.flags.ResourceStringFlag.<init>(int, int, boolean):void type: THIS */
