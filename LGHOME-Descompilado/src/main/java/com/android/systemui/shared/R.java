...
public final class R {
    ...
    public static final class styleable {
        public static final int[] Capability = {0, 0};
        public static int Capability_queryPatterns = 0;
        public static int Capability_shortcutMatchRequired = 1;
        public static final int[] ColorStateListItem = {android.R.attr.color, android.R.attr.alpha, android.R.attr.lStar, 0, 0};
        ...
        public static final int[] FontFamily = {0, 0, 0, 0, 0, 0, 0};
        ...
        public static final int[] FontFamilyFont = {android.R.attr.font, android.R.attr.fontWeight, android.R.attr.fontStyle, android.R.attr.ttcIndex, android.R.attr.fontVariationSettings, 0, 0, 0, 0, 0};
