...
public class QuickStepContract {
    ...
    public static boolean isNaviOnGlobalActions(int i) {
        return (i & 32768) != 0;
    }
    ...
    public static String getSystemUiStateString(int i) {
        ...
        stringJoiner.add((32768 & i) != 0 ? "dialog_showing" : "");
        ...
        stringJoiner.add((16777216 & i) != 0 ? "immersive_mode" : "");
        stringJoiner.add((i & SYSUI_STATE_VOICE_INTERACTION_WINDOW_SHOWING) != 0 ? "vis_win_showing" : "");
