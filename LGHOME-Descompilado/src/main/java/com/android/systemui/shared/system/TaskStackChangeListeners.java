                ...
                switch (message.what) {
                    ...
                    case 2:
                        ...
                        for (int size2 = this.mTaskStackListeners.size() - 1; size2 >= 0; size2--) {
                            zOnTaskSnapshotChanged |= this.mTaskStackListeners.get(size2).onTaskSnapshotChanged(message.arg1, thumbnailData);
                        }
                    ...
                    case 4:
                        ...
                        for (int size4 = this.mTaskStackListeners.size() - 1; size4 >= 0; size4--) {
                            this.mTaskStackListeners.get(size4).onActivityRestartAttempt(runningTaskInfo, z, z2, zOnTaskSnapshotChanged);
                        }
                        break;
                    case 6:
