...
public class PageIndicatorMarker extends FrameLayout {
    ...
    protected ImageView mActiveMarker;
    protected ImageView mInactiveMarker;
    ...
    public void setMarkerDrawables(int activeResId, int inactiveResId) {
        ...
        this.mActiveMarker.setImageDrawable(resources.getDrawable(activeResId));
        this.mInactiveMarker.setImageDrawable(resources.getDrawable(inactiveResId));
    }
