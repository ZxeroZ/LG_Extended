...
public abstract class FolderShape {
    ...
    private static abstract class SimpleRectShape extends FolderShape {
        ...
        @Override // com.android.launcher3.folder.FolderShape
        public final <T extends View & ClipPathView> Animator createRevealAnimator(T target, Rect startRect, Rect endRect, float endRadius, boolean isReversed) {
            return new RoundedRectRevealOutlineProvider(getStartRadius(startRect), endRadius, startRect, endRect) { // from class: com.android.launcher3.folder.FolderShape.SimpleRectShape.1
    ...
    static abstract class PathShape extends FolderShape {
        ...
        public final void drawShape(Canvas canvas, float offsetX, float offsetY, float radius, Paint paint) {
            this.mTmpPath.reset();
            addShape(this.mTmpPath, offsetX, offsetY, radius);
        ...
        public final <T extends View & ClipPathView> Animator createRevealAnimator(final T target, Rect startRect, Rect endRect, float endRadius, boolean isReversed) {
            ...
            valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.launcher3.folder.FolderShape.PathShape.1
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher3.folder.-$$Lambda$FolderShape$PathShape$p4cagRG4khc8bUp7xqZSGnOGcng
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    FolderShape.PathShape.lambda$createRevealAnimator$0(path, animatorUpdateListenerNewUpdateListener, target, valueAnimator);
                }
            });
    ...
    public static final class Circle extends SimpleRectShape {
        ...
        @Override // com.android.launcher3.folder.FolderShape.SimpleRectShape
    ...
    public static class TearDrop extends PathShape {
        ...
        @Override // com.android.launcher3.folder.FolderShape.PathShape
        protected ValueAnimator.AnimatorUpdateListener newUpdateListener(Rect startRect, Rect endRect, float endRadius, final Path outPath) {
            ...
            return new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher3.folder.-$$Lambda$FolderShape$TearDrop$P6FefSzjkyzJKmBEksF5pNrJ2pk
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$newUpdateListener$0$FolderShape$TearDrop(floatArrayEvaluator, fArr, fArr2, outPath, valueAnimator);
                }
            };
        }
    ...
    public static class Squircle extends PathShape {
        ...
        protected ValueAnimator.AnimatorUpdateListener newUpdateListener(Rect startRect, Rect endRect, final float endR, final Path outPath) {
            ...
            final float f3 = 0.0f;
            final float f4 = 0.0f;
            return new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.launcher3.folder.-$$Lambda$FolderShape$Squircle$PZZiUVMkJjKeu-44BFePyclYdzw
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$newUpdateListener$0$FolderShape$Squircle(fExactCenterX, fExactCenterX2, fExactCenterY, fExactCenterY2, fWidth, endR, f, f2, f3, fWidth2, f4, fHeight, outPath, valueAnimator);
                }
            };
        }

        public /* synthetic */ void lambda$newUpdateListener$0$FolderShape$Squircle(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, Path path, ValueAnimator valueAnimator) {
        ...
        try {
            ...
            while (true) {
                ...
                if (next2 == 2) {
                    ...
                    FolderShape shapeDefinition = getShapeDefinition(xml.getName(), typedArrayObtainStyledAttributes.getFloat(0, 1.0f));
    ...
    protected static void pickBestShape(Context context) {
        ...
        for (FolderShape folderShape2 : getAllShapes(context)) {
            path.reset();
            folderShape2.addShape(path, 0.0f, 0.0f, 200 / 2.0f);
