...
public class WidgetHostViewLoader implements DragController.DragListener {
    ...
    public boolean preloadWidget() {
        ...
        this.mBindWidgetRunnable = new Runnable() { // from class: com.android.launcher3.widget.WidgetHostViewLoader.1
        ...
        this.mInflateWidgetRunnable = new Runnable() { // from class: com.android.launcher3.widget.WidgetHostViewLoader.2
            ...
            public void run() {
                ...
                int[] iArrEstimateItemSize = WidgetHostViewLoader.this.mLauncher.getWorkspace().estimateItemSize(WidgetHostViewLoader.this.mInfo, false, true);
    ...
    public static Bundle getDefaultOptionsForWidget(Launcher launcher, PendingAddWidgetInfo info) {
        ...
        Rect defaultPaddingForWidget = AppWidgetHostView.getDefaultPaddingForWidget(launcher, info.componentName, null);
        ...
        if (LGHomeFeature.Config.FEATURE_USE_ROUND_SEARCH_WIDGET.getValue() && LauncherConst.GOOGLE_SEARCH_WIDGET_PACKAGENAME.equals(info.componentName.getPackageName())) {
            bundle.putString("attached-launcher-identifier", "com.lge.launcher3");
    ...
    public static Bundle getDefaultOptionsForWidget(Context context, PendingAddWidgetInfo info) {
        ...
        Rect defaultPaddingForWidget = AppWidgetHostView.getDefaultPaddingForWidget(context, info.componentName, null);
