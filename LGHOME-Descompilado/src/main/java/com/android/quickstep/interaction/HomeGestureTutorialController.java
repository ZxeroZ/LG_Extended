...
final class HomeGestureTutorialController extends SwipeUpGestureTutorialController {
    HomeGestureTutorialController(HomeGestureTutorialFragment fragment, TutorialController.TutorialType tutorialType) {
    ...
    Integer getTitleStringId() {
        ...
        if (i == 1) {
            return Integer.valueOf(R.string.home_gesture_tutorial_playground_title);
        }
        if (i != 2) {
            return null;
        }
    ...
    Integer getSubtitleStringId() {
        if (this.mTutorialType == TutorialController.TutorialType.HOME_NAVIGATION) {
            return Integer.valueOf(R.string.home_gesture_tutorial_playground_subtitle);
        }
        return null;
    }
    ...
    Integer getActionButtonStringId() {
        if (this.mTutorialType == TutorialController.TutorialType.HOME_NAVIGATION_COMPLETE) {
    ...
    public void onNavBarGestureAttempted(NavBarGestureHandler.NavBarGestureResult result, PointF finalVelocity) {
        ...
        if (i == 1) {
            switch (AnonymousClass1.$SwitchMap$com$android$quickstep$interaction$NavBarGestureHandler$NavBarGestureResult[result.ordinal()]) {
                case 1:
                    animateFakeTaskViewHome(finalVelocity, new Runnable() { // from class: com.android.quickstep.interaction.-$$Lambda$HomeGestureTutorialController$lhRu5LfRhOCL_3qARTa-VqtLZmY
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onNavBarGestureAttempted$0$HomeGestureTutorialController();
                        }
                    });
                    break;
                case 2:
                case 3:
                    ...
                    break;
                case 4:
                    fadeOutFakeTaskView(true, new Runnable() { // from class: com.android.quickstep.interaction.-$$Lambda$HomeGestureTutorialController$b6lnDnQDhVUA67nm46menRT9wDA
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onNavBarGestureAttempted$1$HomeGestureTutorialController();
                        }
                    });
                    break;
                case 5:
    ...
    /* JADX INFO: renamed from: com.android.quickstep.interaction.HomeGestureTutorialController$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                iArr3[TutorialController.TutorialType.HOME_NAVIGATION.ordinal()] = 1;
    ...
    public /* synthetic */ void lambda$onNavBarGestureAttempted$0$HomeGestureTutorialController() {
        this.mTutorialFragment.changeController(TutorialController.TutorialType.HOME_NAVIGATION_COMPLETE);
    }

    public /* synthetic */ void lambda$onNavBarGestureAttempted$1$HomeGestureTutorialController() {
